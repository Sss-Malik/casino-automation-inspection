...
<!-- JSVector Maps JS -->
<script src="{{asset('dist/assets/libs/jsvectormap/js/jsvectormap.min.js')}}"></script>

<!-- JSVector Maps MapsJS -->
<script src="{{asset('dist/assets/libs/jsvectormap/maps/world-merc.js')}}"></script>
...
<!-- Gallery JS -->
<script src="{{asset('dist/assets/libs/glightbox/js/glightbox.min.js')}}"></script>
...
{{--<script src="{{asset('dist/assets/js/datatables.js')}}"></script>--}}
